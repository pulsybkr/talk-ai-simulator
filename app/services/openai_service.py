...
def create_initial_context(context):
    ...
    Fournissez un résumé des points clés de la fiche de poste, du profil du candidat, et une liste de questions potentielles pour l'entretien basées sur ces informations. les questions doivent etre naturelles et non scriptées. et ça doit être lie au contexte de l'entretien et la fiche de poste. Mais aussi, les questions doivent ceux poser generalement dans un entretien d'embauche pour le type de poste. comme la presentation du candidat, ses competences, ses qualites, ses defauts, ses motivations, ses objectifs, ses passions, ses loisirs, ses passions, ses valeurs, ses qualites, ses defauts, ses motivations, ses objectifs, ses passions, ses loisirs, ses passions, ses valeurs, ses qualites, ses defauts, ses motivations, ses objectifs, ses passions, ses loisirs, ses passions, ses valeurs."""
